                ...
                <div className='faq-content'>
                    ...
                    <div className='all-questions'>
                      ...
                      <div className='faq-box'>
                        <div id='q1' onClick={ ()=>openQ("q1")} className={`faq-box-question ${getClassQuestion("q1")}`}>
                        <p>1. What is special about comparing rental car deals?</p>
                        <IconChevronDown />
                        </div>

                        <div id='q1' onClick={()=> openQ("q1")} className={`faq-box-answer ${getClassAnswer("q1")}`}>
                      ...
                      <div className='faq-box'>
                        <div id='q2' onClick={()=>openQ("q2")} className={`faq-box-question ${getClassQuestion("q2")} `} >
                        <p>2. How do I find the car rental deals?</p>
                        <IconChevronDown />
                        </div>

                        <div id='q2' onClick={()=>openQ("q2")} className={`faq-box-answer ${getClassAnswer("q2")}`}>
                  ...
                  deals or promotions.
                      ...
                      <div className='faq-box'>
                        <div id='q3' className={`faq-box-question ${getClassQuestion("q3")}`} onClick={()=>openQ("q3")}><p> 3. How do I find such low rental car prices? </p>
                        <IconChevronDown />
                        </div>
                        
                        <div id='q3' className={`faq-box-answer ${getClassAnswer("q3")}`}>
